...
export const API_ENDPOINTS = {
    ...
    LOGOUT: '/auth/logout',
    DEVICE_REGISTRATION: '/auth/device-registration',
    DEVICE_REGISTRATION_TOKENS: '/auth/device-registration/tokens',
    DEVICE_REGISTRATION_REVOKE: '/auth/device-registration/revoke',
