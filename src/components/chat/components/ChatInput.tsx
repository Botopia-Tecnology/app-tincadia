...
export const ChatInput = forwardRef<ChatInputHandle, ChatInputProps>(function ChatInputInner(props, ref) {
  ...
  const { registerTarget } = useProductTourContext();
  ...
  return (
    <View style={[chatViewStyles.inputContainer, {
        ...
        return (
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)', padding: 8, borderLeftWidth: 4, borderLeftColor: '#4F46E5', marginBottom: 4 }}>
            <View style={{ flex: 1 }}>
              ...
              <Text numberOfLines={1} style={{ color: finalColors.textSecondary, fontSize: 12 }}>{formattedReplyContent}</Text>
            </View>
      ...
      <View style={chatViewStyles.inputRow}>
        <Animated.View 
          ref={registerTarget('chat_input_text')}
          style={[chatViewStyles.inputWrapper, { backgroundColor: isDark ? finalColors.inputBg : '#F3F4F6' }, animatedInputStyle]}
        >
          <AnimatedGradient
        ...
        <View style={chatViewStyles.actionsRow}>
          <View style={chatViewStyles.leftActions}>
            ...
            <TouchableOpacity 
              ref={registerTarget('chat_video_call')}
              style={[chatViewStyles.mediaButton, { backgroundColor: isDark ? finalColors.inputBg : '#F3F4F6' }]} 
          ...
          {messageText.trim() ? (
            ...
            <TouchableOpacity 
              ref={registerTarget('chat_mic')}
              style={[chatViewStyles.micButton, { backgroundColor: isDark ? finalColors.inputBg : '#F3F4F6' }]} 
